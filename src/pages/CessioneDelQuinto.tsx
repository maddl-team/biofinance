                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        <div className="bg-neutral-bg p-8 rounded-2xl border border-gray-100 shadow-sm transition-transform hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold text-primary mb-4">Rata Fissa e Sostenibile</h3>
                        ...
                        <div className="bg-neutral-bg p-8 rounded-2xl border border-gray-100 shadow-sm transition-transform hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold text-primary mb-4">Prelievo alla Fonte</h3>
                            <p className="text-gray-600">
                        ...
                        <div className="bg-neutral-bg p-8 rounded-2xl border border-gray-100 shadow-sm transition-transform hover:-translate-y-1">
                            ...
                            <h3 className="text-xl font-bold text-primary mb-4">Durata Flessibile</h3>
                            <p className="text-gray-600">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col bg-white p-8 rounded-2xl border-b-4 border-secondary shadow-sm">
                            ...
                            <h3 className="text-2xl font-bold text-primary mb-4">1. Dipendenti Pubblici e Statali</h3>
                            ...
                            <a href="#" className="inline-flex items-center text-secondary font-bold hover:underline group">
                        ...
                        <div className="flex flex-col bg-white p-8 rounded-2xl border-b-4 border-secondary shadow-sm">
                            ...
                            <h3 className="text-2xl font-bold text-primary mb-4">2. Dipendenti Privati</h3>
                            <p className="text-gray-600 mb-6 flex-grow">
                        ...
                        <div className="flex flex-col bg-white p-8 rounded-2xl border-b-4 border-secondary shadow-sm">
                            ...
                            <h3 className="text-2xl font-bold text-primary mb-4">3. Pensionati INPS ed ex-INPDAP</h3>
                            <p className="text-gray-600 mb-6 flex-grow">
                        ...
                        <div>
                            ...
                            <div className="space-y-6">
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-primary text-lg">Accessibile ai "Cattivi Pagatori"</h4>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-primary text-lg">Nessun Giustificativo di Spesa</h4>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-primary text-lg">Assicurazione Inclusa per Legge</h4>
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <div>
                                        <h4 className="font-bold text-primary text-lg">Possibilità di Rinnovo</h4>
                                        ...
                                        <a href="#" className="text-secondary font-bold text-sm mt-2 inline-block">Scopri come funziona il Rinnovo →</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div className="p-8 lg:p-12">
                                ...
                                <div className="space-y-4">
                                    <div className="flex justify-between items-center py-4 border-b border-gray-100">
                                        ...
                                        <span className="font-bold text-primary">Da 18 a 85 anni (a fine piano)</span>
                                    </div>
                                    <div className="flex justify-between items-center py-4 border-b border-gray-100">
                                        <span className="text-gray-600">Contratto</span>
                                        <span className="font-bold text-primary">Tempo indeterminato (dipendenti)</span>
                                    </div>
                                    <div className="flex justify-between items-start py-4 border-b border-gray-100">
                                        <span className="text-gray-600">Documenti Base</span>
                                        <span className="font-bold text-primary text-right">CI, CF, Ultimi 2 cedolini</span>
                                    </div>
                                    <div className="flex justify-between items-start py-4">
                                        <span className="text-gray-600">Certificato di Stipendio</span>
                                        <span className="font-bold text-primary text-right max-w-[200px]">Ci pensiamo noi a richiederlo</span>
                                    </div>
                                </div>
                            </div>
