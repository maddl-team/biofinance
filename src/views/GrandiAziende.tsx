    ...
    return (
        <div className="bg-white">
            ...
            <FAQ
                ...
                items={[
                    {
                        question: <span className="font-bold">La mia azienda (SRL) ha solo 8 dipendenti, posso chiedere la Cessione?</span>,
                        answer: <><span className="font-bold"></span> <span className="font-bold">NON SI PUO’ FARE</span>.</>
                    },
                    {
                        question: <span className="font-bold">L'azienda deve dare il consenso al prestito?</span>,
                        answer: <><span className="font-bold"></span> Il datore di lavoro non può rifiutare la Cessione del Quinto per legge (è un diritto del dipendente), ma deve firmare l'Atto di Benestare e impegnarsi a trattenere la rata. Nelle Grandi Aziende questa è una procedura standard gestita automaticamente dall'ufficio HR.</>
                    },
                    {
                        question: <span className="font-bold">Se ho un pignoramento in corso, posso fare la Cessione se lavoro nel privato?</span>,
                        answer: <><span className="font-bold"></span> Assolutamente sì. La Cessione del Quinto può coesistere con un pignoramento purché la somma delle trattenute non superi il 50% dello stipendio netto. È una soluzione spesso usata proprio per ottenere liquidità e chiudere posizioni debitorie pregresse.</>
                    }
                ]}
            />
        </div>
