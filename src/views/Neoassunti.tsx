            ...
            <FAQ
                ...
                items={[
                    ...
                    },
                    {
                        ...
                        answer: <><span className="font-bold"></span> Nella Cessione del Quinto il garante (inteso come persona fisica) non serve e non viene richiesto. La garanzia è solo il TFR e la busta paga. Se non hai anzianità sufficiente, il garante non può sbloccare la pratica di Cessione, ma potrebbe servire per un Prestito Personale classico.</>
                    },
                    {
                        question: <span className="font-bold">Se lavoro in un'agenzia interinale posso chiedere il prestito?</span>,
                        answer: <><span className="font-bold"></span> I contratti tramite agenzia interinale sono spesso a tempo determinato. Per la Cessione del Quinto serve un contratto a tempo indeterminato diretto con l'azienda.</>
                    }
                ]}
            />
        </div>
