    ...
    return (
        <div className="bg-white">
            ...
            <FAQ
                ...
                items={[
                    {
                        question: <><span className="font-bold"></span> Sono un Carabiniere, se vado in pensione la cessione continua?</>,
                    ...
                    {
                        question: <><span className="font-bold"></span> Le indennità di turno notturno rientrano nel calcolo?</>,
                    ...
                    {
                        question: <><span className="font-bold"></span> Ho un contratto a tempo determinato in ASL (Emergenza), posso chiedere il prestito?</>,
