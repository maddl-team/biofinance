                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        ...
                        <div className="flex flex-col bg-white p-8 rounded-2xl border-b-4 border-secondary shadow-sm">
                            ...
                            <Link href="/dipendenti-statali" className="inline-flex items-center text-secondary font-bold hover:underline group">
                        ...
                        <div className="flex flex-col bg-white p-8 rounded-2xl border-b-4 border-secondary shadow-sm">
                            ...
                            <Link href="/dipendenti-privati" className="inline-flex items-center text-secondary font-bold hover:underline group">
                        ...
                        <div className="flex flex-col bg-white p-8 rounded-2xl border-b-4 border-secondary shadow-sm">
                            ...
                            <Link href="/prestiti-pensionati" className="inline-flex items-center text-secondary font-bold hover:underline group">
