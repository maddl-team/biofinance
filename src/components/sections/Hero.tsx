                ...
                <div className="grid grid-cols-1 gap-16 lg:grid-cols-2 lg:items-center">
                    <div className="max-w-2xl text-center lg:text-left flex flex-col items-center lg:items-start">
                        ...
                        <div className="space-y-6 text-lg text-gray-600 leading-relaxed text-left mb-10">
                            <p>
                                In <span className="font-bold text-primary">Biofinanc</span> crediamo che accedere al credito sia un diritto, non un percorso a ostacoli. Siamo un'agenzia finanziaria regolarmente iscritta all'OAM specializzata in Cessione del Quinto dello stipendio e della pensione.
                            </p>
                            <p>
