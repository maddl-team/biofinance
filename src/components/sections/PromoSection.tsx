...
const PromoSection: React.FC = () => {
    ...
    return (
        <div className="bg-neutral-bg">
            <section
                className="relative pt-16 pb-16 lg:pt-32 lg:pb-32 overflow-hidden bg-primary [clip-path:none] md:[clip-path:polygon(0%_100%,_100%_100%,_100%_6.371%,_100%_4.064%,_100%_4.064%,_99.991%_4.048%,_99.963%_3.998%,_99.913%_3.913%,_99.835%_3.794%,_99.727%_3.639%,_99.586%_3.448%,_99.407%_3.219%,_99.187%_2.954%,_98.923%_2.65%,_98.611%_2.307%,_98.239%_1.952%,_97.797%_1.614%,_97.289%_1.297%,_96.718%_1.005%,_96.085%_0.742%,_95.394%_0.512%,_94.647%_0.319%,_93.847%_0.167%,_92.996%_0.059%,_92.097%_0.001%,_88.771%_0.331%,_81.338%_1.283%,_70.847%_2.704%,_58.35%_4.438%,_44.895%_6.33%,_31.532%_8.225%,_19.312%_9.968%,_9.283%_11.405%,_2.496%_12.381%,_0%_12.741%,_0%_100%)]"
            >
