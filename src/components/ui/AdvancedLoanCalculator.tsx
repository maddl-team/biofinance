        ...
        <div className="w-full max-w-2xl mx-auto rounded-3xl bg-white p-8 lg:p-10 shadow-2xl border border-secondary/20 relative z-10">
            ...
            {step === 1 ? (
                ...
                <div className="text-center py-10 space-y-6">
                    ...
                    <div>
                        <h3 className="text-2xl font-bold text-primary mb-2">Analisi Ricevuta!</h3>
                        <p className="text-gray-600 italic">Abbiamo preso in carico la tua simulazione. Ti contatteremo a breve per i dettagli.</p>
                    </div>
                    <button
                        onClick={() => {
                            setStep(1);
                            setIsSuccess(false);
                            setFormData(prev => ({ ...prev, firstName: '', lastName: '', email: '', phone: '', privacy: false }));
                        }}
