            ...
            <div className="space-y-10">
                ...
                <div>
                    ...
                    <input
                        ...
                        style={{
                            background: `linear-gradient(to right, #C1121F 0%, #C1121F ${(amount - 500) / (30000 - 500) * 100}%, #f3f4f6 ${(amount - 500) / (30000 - 500) * 100}%, #f3f4f6 100%)`
                        }}
                    />
                ...
                <div>
                    ...
                    <input
                        ...
                        className="w-full h-2 bg-gray-100 rounded-lg appearance-none cursor-pointer accent-secondary"
                        style={{
                            background: `linear-gradient(to right, #C1121F 0%, #C1121F ${(installments - 6) / (84 - 6) * 100}%, #f3f4f6 ${(installments - 6) / (84 - 6) * 100}%, #f3f4f6 100%)`
                        }}
                    />
                    <div className="flex justify-between text-sm text-gray-400 mt-3 font-medium">
                        <span>6 rate</span>
